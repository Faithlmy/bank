			...
			<td><table width="100%" border="0" cellpadding="0"
					...
					<tr>
						...
						<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
								align="center">
								<div align="center">
									<input type="text" class="STYLE19" name="user_id" />
								</div>
							</div>
						</td>
						<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
					...
					<tr>
						...
						<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
								align="center">用户名:</div>
						</td>
						<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
								align="center">
								<div align="center">
									<input lass="easyui-validatebox" required="true"
					...
					<tr>
						...
						<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
								align="center">
								<input type="text" class="STYLE19" name="depart_name" />
							</div>
						</td>
						<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
								align="center"></div>
					...
					<tr>
						...
						<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
								align="center">
								<input type="text" class="STYLE19" name="user_tel" />
							</div>
						</td>
						<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
								align="center"></div>
					...
					<tr>
						...
						<td height="20" bgcolor="#FFFFFF" class="STYLE19">g<div
								align="center"></div>
						</td>
					</tr>
				</table>
