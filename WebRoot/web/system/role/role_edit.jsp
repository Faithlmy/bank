...
<link rel="stylesheet" type="text/css" href="web/css/web/add.css"></link>
<link rel="stylesheet" href="web/css/web/dtree.css" type="text/css"></link>
<script type="text/javascript" src="web/js/mydtree.js"></script>
...
<body>
	<form action="role.do?opt=updRole" method="post">
															...
															<tr>
																<td height="19" valign="bottom" width="6%"><div
																		...
																		<span class="STYLE1"> <img
																			src="web/images/tb.gif" height="14" width="14" />
																			修改角色</span>
																	</div></td>
															</tr>
														</tbody>
						...
						<tbody>
							...
							<tr>
								...
								<td height="25" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">
									<input type="text" class="easyui-validatebox"  value="${roleInfo.role_id}" required="true" class="STYLE19" 
							...
							<tr>
								...
								<td height="25" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">
									<input type="text" class="easyui-validatebox" value="${roleInfo.role_type}" required="true" class="STYLE19" name ="role_type" id="role_type" /></div>
								</td>
								<td class="STYLE19" bgcolor="#FFFFFF" height="25"><div
										align="center"></div></td>
							</tr>
							<tr>
								...
								<td height="25" bgcolor="#FFFFFF" class="STYLE19"><div
									...
									<input type="text" class="easyui-validatebox" value="${roleInfo.role_describe}" required="true" class="STYLE19"
							...
							<td bgcolor="#FFFFFF" height="25"><div align="center">
								...
								<td height="60" bgcolor="#FFFFFF" class="STYLE19"><div
